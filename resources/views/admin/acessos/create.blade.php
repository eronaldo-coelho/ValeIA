...
<head>
    ...
    <title>Novo Usuário - ValeIA</title>
    ...
    <div class="flex h-screen overflow-hidden pt-16 md:pt-0">
        ...
        <main class="flex-1 overflow-y-auto bg-slate-50 p-4 md:p-8" @click="sidebarOpen = false">
            ...
            <header class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-slate-800">Cadastrar Usuário</h1>
                    <p class="text-slate-500">Defina o cargo e as permissões de acesso.</p>
                </div>
            </header>

            <form action="{{ route('admin.acessos.store') }}" method="POST" class="max-w-4xl">
                @csrf
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 h-fit">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="name" required class="w-full bg-slate-50 border border-slate-200 rounded-lg p-2.5 focus:ring-brand-500 focus:border-brand-500 outline-none">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-1">E-mail Corporativo</label>
                                <input type="email" name="email" required class="w-full bg-slate-50 border border-slate-200 rounded-lg p-2.5 focus:ring-brand-500 focus:border-brand-500 outline-none">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-1">Senha de Acesso</label>
                                <input type="password" name="password" required class="w-full bg-slate-50 border border-slate-200 rounded-lg p-2.5 focus:ring-brand-500 focus:border-brand-500 outline-none">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 h-fit">
                        ...
                        <div class="mb-6">
                            ...
                            <select name="role" class="w-full bg-slate-50 border border-slate-200 rounded-lg p-2.5 focus:ring-brand-500 focus:border-brand-500 outline-none">
                                <option value="funcionario">Funcionário (Básico)</option>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-3">Permissões Adicionais (Opcional)</label>
                            <div class="space-y-2">
                                ...
                                <label class="flex items-center gap-3 p-3 border border-slate-100 rounded-lg hover:bg-slate-50 cursor-pointer">
                                    <input type="checkbox" name="permissions[]" value="aprovar_notas" class="w-4 h-4 text-brand-600 rounded focus:ring-brand-500">
                                ...
                                <label class="flex items-center gap-3 p-3 border border-slate-100 rounded-lg hover:bg-slate-50 cursor-pointer">
                                    <input type="checkbox" name="permissions[]" value="visualizar_relatorios" class="w-4 h-4 text-brand-600 rounded focus:ring-brand-500">
                                ...
                                <label class="flex items-center gap-3 p-3 border border-slate-100 rounded-lg hover:bg-slate-50 cursor-pointer">
                                    <input type="checkbox" name="permissions[]" value="gerenciar_saldo" class="w-4 h-4 text-brand-600 rounded focus:ring-brand-500">
                                ...
                                <label class="flex items-center gap-3 p-3 border border-slate-100 rounded-lg hover:bg-slate-50 cursor-pointer">
                                    <input type="checkbox" name="permissions[]" value="reembolsar" class="w-4 h-4 text-brand-600 rounded focus:ring-brand-500">
                                ...
                                <label class="flex items-center gap-3 p-3 border border-slate-100 rounded-lg hover:bg-slate-50 cursor-pointer">
                                    <input type="checkbox" name="permissions[]" value="auditoria" class="w-4 h-4 text-brand-600 rounded focus:ring-brand-500">
                                ...
                                <label class="flex items-center gap-3 p-3 border border-slate-100 rounded-lg hover:bg-slate-50 cursor-pointer">
                                    <input type="checkbox" name="permissions[]" value="gerenciar_equipe" class="w-4 h-4 text-brand-600 rounded focus:ring-brand-500">
                ...
                <div class="mt-8 flex justify-end gap-3">
                    ...
                    <button type="submit" class="px-6 py-3 rounded-lg bg-brand-600 text-white hover:bg-brand-800 font-bold shadow-lg shadow-brand-500/20">Salvar Usuário</button>
                </div>
            </form>
        </main>
    </div>
